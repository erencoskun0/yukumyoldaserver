    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoadStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BodyName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeparturevId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.LoadStatusId,
                        principalTable: "LoadStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Loads_Provinces_DeparturevId",
                        column: x => x.DeparturevId,
                        principalTable: "Provinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Loads_Provinces_DestinationProvinceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Evaluation_SelfEvaluation", "[EvaluatorUserId] <> [EvaluatedUserId]");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Evaluations_Loads_LoadId",
                        column: x => x.LoadId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLoads", x => new { x.UserId, x.LoadId });
                    table.ForeignKey(
                        name: "FK_UserLoads_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserLoads_Loads_LoadId",
                        column: x => x.LoadId,
                        principalTable: "Loads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_EvaluatorUserId_LoadId",
                table: "Evaluations",
                columns: new[] { "EvaluatorUserId", "LoadId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_LoadId",
                table: "Evaluations",
                column: "LoadId");

            migrationBuilder.CreateIndex(
                name: "IX_Loads_DeparturevId",
                table: "Loads",
                column: "DeparturevId");

            migrationBuilder.CreateIndex(
                name: "IX_Loads_DestinationProvinceId",
                table: "Loads",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoadStatuses_StateName",
                table: "LoadStatuses",
                column: "StateName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleBodies_BodyName",
                table: "VehicleBodies",
                column: "BodyName",
                unique: true);
